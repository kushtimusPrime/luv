...
from fcvision.utils.vision_utils import (
    get_hdr_capture,
    get_high_sat_capture,
    get_high_sat_img,
    get_multi_exposure_img,
)
...
COMMON_THRESHOLDS = {
    ...
    "red": [
        (np.array([0, 80, 100]), np.array([20, 255, 255])),
    ...
    "data/green_towel": [
        (np.array([140, 60, 100]), np.array([180, 255, 255])),
        (np.array([0, 80, 100]), np.array([20, 255, 255])),
    ],
    "data/bright_green_towel": [
        (np.array([140, 60, 100]), np.array([180, 255, 255])),
        (np.array([0, 80, 100]), np.array([20, 255, 255])),
    ],
    "data/yellow_towel": [(np.array([140, 20, 100]), np.array([170, 255, 255]))],
    "data/misc_towels": [
        (np.array([140, 60, 50]), np.array([180, 255, 255])),
        (np.array([0, 60, 50]), np.array([20, 255, 255])),
        (np.array([134, 60, 100]), np.array([150, 255, 255])),
    ],
...
def get_segmasks(
    zed, plug, color_bounds, GAIN, EXPS, plot=True, capture_fn=get_hdr_capture
):
    zed.set_gain(GAIN)
    plug.turn_on()
